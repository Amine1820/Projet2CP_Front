  ...
  const scrollToBottom = () => {
    ...
    /></Link>
      ...
      <div className="  flex flex-row gap-4 justify-center font-ubuntu text-[17px] hidden md:flex" id="menu">
        ...
        <p className="mr-6">
        <a href="/Evenements" className="text-white hover:text-gray-300 active:text-red-600 focus:text-red-600">Evenements</a>
        </p>
        <p className="mr-6">
        <a href="/Besoins" className=" text-white hover:text-gray-300 active:text-red-600 focus:text-red-600">Nos besoins</a>
        </p>
        <p className="mr-6">
      ...
      <div style={{backgroundColor: '#F9DBBB' }} className="z-12  hidden font-bold fixed opacity-80 ml-[53%] lg:ml-[77%] sm:ml-[52%] md:ml-[67%] w-64 rounded-xl mt-56 flex justify-center px-1 py-4" id="profila">
    <ul className="space-y-3" >
      ...
      profila.classList.add('hidden');
        ...
        <li className="mr-6">
            <Link to="#" onClick={()=>{const profila = document.querySelector('#profila');
      profila.classList.add('hidden');
    }} className=" text-black hover:text-gray-300 underline underline-offset-8 opacity-90">Demandes de reaffectation</Link>
        </li>
        <li className="mr-6">
            <Link to="#" onClick={()=>{const profila = document.querySelector('#profila');
      profila.classList.add('hidden');
    }} className=" text-black hover:text-gray-300 underline underline-offset-8 opacity-90">Demandes de rejoint</Link>
        </li>
    </ul>
  </div>
