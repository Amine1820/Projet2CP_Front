...
const Navbar = () => {
  ...
  return (
    <div className="">
      <nav className="shadow-lg p-5 px-7 bg-green-500 font-bold text-white">
        <div className="flex justify-between">
          ...
          <div>
            <ul className="items-center flex text-xl space-x-5 justify-between">
              ...
              <li>
                ...
                onClick={()=>{
                  navigate('/register')
                }} className="border-blue-600 active:border-b-0 w-28 rounded-full bg-blue-500 px-4 py-3 border-b-2 hover:bg-blue-400">
                Sign up  
                </button>
              </li>
              <li>
